...
public class Main {
    ...
    public static int[][] board = new int[41][41];
    public static int[][] knights = new int[31][5];
    public static int[][] newKnights = new int[31][3];
    ...
    public static boolean canMove(int idx, int dir) {
        ...
        while (!que.isEmpty()) {
            ...
            for (int i = newKnights[cur][0]; i < knights[cur][2] + newKnights[cur][0]; i++) {
                for (int j = newKnights[cur][1]; j < knights[cur][3] + newKnights[cur][1]; j++) {
                    if (board[i][j] == 1) {
                        newKnights[cur][2]++;
                    } else if (board[i][j] == 2) {
                        return false;
