...
public class Main {
    ...
    static int[] powers = new int[100001];
    static int[][] arr = new int[100001][21];
    static int[] values = new int[100001];
    static boolean[] onOffs = new boolean[100001];
    ...
    static void toggleOnOffs(int c) {
        int cur = parents[c];
        int num = 1;
